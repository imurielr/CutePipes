...
void closeInitial(map<string,map<string, int[2]>> &initial, string &name){}
void closeError(map<string,map<string, int[2]>> &error, string &name){}
void closeEdges(map<string,vector<arista>> &graph, string &name){}
